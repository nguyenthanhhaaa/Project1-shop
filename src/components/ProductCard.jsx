...
export default function ProductCard({ product = {}, onAddToCart = () => {} }) {
  ...
  return (
    <article className="bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col hover:shadow-lg transition-transform duration-300 hover:-translate-y-1">
      <button
        type="button"
        onClick={handleOpenDetail}
        className="relative w-full h-48 md:h-56 lg:h-64 overflow-hidden bg-gray-100"
